...
load(fullfile(ResultsMatDir,"HighRes_Canal_50kPa.mat"),"xy","t","b","x_surf","x_base"); % Load essential independent variables for plotting

%%% Load essential dependent variables for plotting
Canal50kPa = load(fullfile(ResultsMatDir,"HighRes_Canal_50kPa.mat"),"u","u_surf","basal_tau_c_specific");

Canal100kPa = load(fullfile(ResultsMatDir,"HighRes_Canal_100kPa.mat"),"u","u_surf","basal_tau_c_specific");

Canal150kPa = load(fullfile(ResultsMatDir,"HighRes_Canal_150kPa.mat"),"u","u_surf","basal_tau_c_specific");

RChannel550kPa = load(fullfile(ResultsMatDir,"HighRes_RChannel_550kPa.mat"),"xy","t","b","x_surf","x_base","u","u_surf","basal_tau_c_specific");

RChannel520kPa = load(fullfile(ResultsMatDir,"HighRes_RChannel_520kPa.mat"),"xy","t","b","x_surf","x_base","u","u_surf","basal_tau_c_specific");

LinkedCavity250kPa = load(fullfile(ResultsMatDir,"HighRes_LinkedCavity_250kPa.mat"),"u","u_surf","basal_tau_c_specific");

LinkedCavity500kPa = load(fullfile(ResultsMatDir,"HighRes_LinkedCavity_500kPa.mat"),"u","u_surf","basal_tau_c_specific");

WaterFilm4000Pa = load(fullfile(ResultsMatDir,"HighRes_WaterFilm_4000Pa.mat"),"u","u_surf","basal_tau_c_specific");

WaterFilm5333Pa = load(fullfile(ResultsMatDir,"HighRes_WaterFilm_5333Pa.mat"),"u","u_surf","basal_tau_c_specific");

%% 2D ice speed map Canal 50 kPa
figure;
...
%% 2D ice speed map Canal 100 kPa
figure;
...
%% 2D ice speed map Canal 150 kPa
figure;
...
%% 2D ice speed map R-Channel 550 kPa
figure;
...
%% 2D ice speed map R-Channel 520 kPa
figure;
...
%% Ice Surface Speed profiles Fig. 2 (f) R-Channel
figure;
%x_surf = xy(xy(:,2) > max(xy(:,2))-dx/100,1);
%u_surf = u(xy(:,2) > max(xy(:,2))-dx/100);
...
%% Basal Drag Profiles Fig. 2 (e) R-Channel
figure
%yyaxis left
